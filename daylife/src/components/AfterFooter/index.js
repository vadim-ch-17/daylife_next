    ...
    return (
        <div className="border-t-1 border-gray">
            <div className="container relative flex-col md:flex-row flex mx-auto px-3 py-4 text-center lg:text-left">
                ...
                <Link href={`/privacy-policy/`} className="flex items-center justify-center relative md:absolute left-2/4 -translate-x-2/4 transition-colors w-full text-xs !text-lightgray underline hover:!text-active active:!text-active">{t('title')}</Link>
            </div>
        </div>
    )
}
