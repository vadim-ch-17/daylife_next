    ...
    return (
        <div className="content">
            <div className="image md-7 lg:mb-14">
                <ResponsiveImage
                    classes={"h-52 lg:h-auto mx-auto lazy"} loadImg={"lazy"} src={t("success.image.src")} alt={t("success.image.alt")} />
            </div>
            ...
            <div className="text-center mb-10 lg:mb-20">
                <Button
                    hoverAnimation
                    label={t("success.button")}
                    classes="text-white min-w-[193px] h-[3.625rem] bg-visited rounded-[0.625rem] hover:cursor-pointer hover:bg-white border-[1px] hover:text-visited border-visited transition duration-300 mx-auto"
                    onClick={() => setIsOpenModal(false)}>{t("success.button")}</Button>
            </div>
        </div>
    )
};
